!
! auto-generated by op2.py on 2013-01-21 13:31
!
...
SUBROUTINE bres_calc_host( userSubroutine, set, &
  ...
  CALL c_f_pointer(C_LOC(actualPlan_bres_calc%ind_sizes),ind_sizes_bres_calc,(/actualPlan_bres_calc%nblocks * numberOfIndirectOpDats/))
  CALL c_f_pointer(C_LOC(actualPlan_bres_calc%ind_offs),ind_offs_bres_calc,(/actualPlan_bres_calc%nblocks * numberOfIndirectOpDats/))
  CALL c_f_pointer(C_LOC(actualPlan_bres_calc%blkmap),blkmap_bres_calc,(/actualPlan_bres_calc%nblocks/))
  CALL c_f_pointer(C_LOC(actualPlan_bres_calc%offset),offset_bres_calc,(/actualPlan_bres_calc%nblocks/))
  CALL c_f_pointer(C_LOC(actualPlan_bres_calc%nelems),nelems_bres_calc,(/actualPlan_bres_calc%nblocks/))
  CALL c_f_pointer(C_LOC(actualPlan_bres_calc%nthrcol),nthrcol_bres_calc,(/actualPlan_bres_calc%nblocks/))
  CALL c_f_pointer(C_LOC(actualPlan_bres_calc%thrcol),thrcol_bres_calc,(/set%setPtr%size/))
