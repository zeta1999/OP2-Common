...
program AIRFOIL
  ...
  do niter = 1, iterationNumber
     ...
     call save_soln_host("save_soln" //C_NULL_CHAR ,cells, &
    ...
    do k = 1, 2
      ...
      call adt_calc_host("adt_calc" //C_NULL_CHAR,cells, &
      ...
      call res_calc_host("res_calc" //C_NULL_CHAR,edges, &
      ...
      call bres_calc_host("bres_calc" //C_NULL_CHAR,bedges, &
      ...
      call update_host("update" //C_NULL_CHAR,cells, &
