...
SUBROUTINE res_calc_host( userSubroutine, set, &
  ...
  CALL c_f_pointer(C_LOC(actualPlan_res_calc%ind_sizes),ind_sizes_res_calc,(/actualPlan_res_calc%nblocks * numberOfIndirectOpDats/))
  CALL c_f_pointer(C_LOC(actualPlan_res_calc%ind_offs),ind_offs_res_calc,(/actualPlan_res_calc%nblocks * numberOfIndirectOpDats/))
  CALL c_f_pointer(C_LOC(actualPlan_res_calc%blkmap),blkmap_res_calc,(/actualPlan_res_calc%nblocks/))
  CALL c_f_pointer(C_LOC(actualPlan_res_calc%offset),offset_res_calc,(/actualPlan_res_calc%nblocks/))
  CALL c_f_pointer(C_LOC(actualPlan_res_calc%nelems),nelems_res_calc,(/actualPlan_res_calc%nblocks/))
  CALL c_f_pointer(C_LOC(actualPlan_res_calc%nthrcol),nthrcol_res_calc,(/actualPlan_res_calc%nblocks/))
  CALL c_f_pointer(C_LOC(actualPlan_res_calc%thrcol),thrcol_res_calc,(/set%setPtr%size/))
