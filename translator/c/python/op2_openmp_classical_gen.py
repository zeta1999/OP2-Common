...
####################################################################################
#                                                                                  #
#       This Python routine generates the header file op_openmp_classical.h        #
#                                                                                  #
####################################################################################
...
for nargs in range (1,maxargs+1):
    ...
    for n in range (0, nargs):
        f.write('   TYPE('+str(n)+') * arg'+str(n)+'h;\n')
        f.write('   if(args['+str(n)+'].argtype == OP_ARG_GBL && args['+str(n)+'].acc != OP_READ)\n')
        f.write('       arg'+str(n)+'h = (TYPE('+str(n)+') *)args['+str(n)+'].data;\n')
...
#    f.write('exit(0);\n')
    ...
    f.write('	if(reduct  && col == Plan->ncolors_owned-1)\n')
    f.write('	{\n')
