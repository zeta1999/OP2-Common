...
MODULE GETQ_CHRISTIENSEN_Q_MODULE
...
!DEC$ ATTRIBUTES FORCEINLINE :: getq_christiensen_q
...
SUBROUTINE op_wrap_getq_christiensen_q( &
& opDat1Local, &
& opDat2Local, &
& opDat3Local, &
& opDat4Local, &
...
END DO
END SUBROUTINE
SUBROUTINE getq_christiensen_q_host( userSubroutine, set, &
& opArg1, &
& opArg2, &
& opArg3, &
& opArg4, &
...
! kernel call
    CALL op_wrap_getq_christiensen_q( &
    & opDat1Local, &
    & opDat2Local, &
    & opDat3Local, &
    & opDat4Local, &
