...
MODULE LAGSTEP_HALF_POS_MODULE
...
!DEC$ ATTRIBUTES FORCEINLINE :: lagstep_half_pos
...
SUBROUTINE op_wrap_lagstep_half_pos( &
  & opDat1Local, &
  & opDat2Local, &
  & opDat3Local, &
  & opDat4Local, &
...
! kernel call
  ...
  END DO
END SUBROUTINE
SUBROUTINE lagstep_half_pos_host( userSubroutine, set, &
  & opArg1, &
  & opArg2, &
  & opArg3, &
  & opArg4, &
