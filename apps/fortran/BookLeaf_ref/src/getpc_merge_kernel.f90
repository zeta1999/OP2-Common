...
!DEC$ ATTRIBUTES FORCEINLINE :: getpc_merge
...
SUBROUTINE op_wrap_getpc_merge( &
& opDat1Local, &
& bottom,top)
...
END DO
END SUBROUTINE
SUBROUTINE getpc_merge_host( userSubroutine, set, &
& opArg1 )
