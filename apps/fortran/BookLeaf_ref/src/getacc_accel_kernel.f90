...
!DEC$ ATTRIBUTES FORCEINLINE :: getacc_accel
...
SUBROUTINE op_wrap_getacc_accel( &
& opDat1Local, &
& opDat2Local, &
& opDat3Local, &
& opDat4Local, &
...
END DO
END SUBROUTINE
SUBROUTINE getacc_accel_host( userSubroutine, set, &
& opArg1, &
& opArg2, &
& opArg3, &
& opArg4 )
