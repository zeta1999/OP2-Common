!
! auto-generated by op2_fortran.py on 2015-01-16 11:52
!
...
END SUBROUTINE init_memory
  ...
  USE utilities_mod,ONLY: sort,arth
    ...
    ! result
    INTEGER(KIND=ink),DIMENSION(nFace,nCell),INTENT(OUT)            :: e2e
    ! local
...
&                                            w2,w3,w4
  ...
  call getconn2(nel1,nshape,ielnod(1:,1:nel1),ielel(1:,1:nel1))
