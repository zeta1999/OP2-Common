...
CONTAINS
  ...
  use GETACC_ACCEL_MODULE
  use GETACC_BC_MODULE
  use GETACC_AVGVEL_MODULE
  use GETACC_UPDPOS_MODULE
...
&                           d_cnmass,d_cnwt,d_indtype,d_ndu,d_ndv,d_ndx,d_ndy
    ...
    call getacc_scatter_host(&
                     & "getacc_scatter",s_elements,  &
...
!    ENDDO
    ...
    call getacc_accel_host(&
                     & "getacc_accel",s_nodes,  &
    ...
    call getacc_avgvel_host(&
                     & "getacc_avgvel",s_nodes,  &
                     & op_arg_dat(d_ndub,-1,OP_ID,1,'real(8)',OP_RW),  &
                     & op_arg_dat(d_ndvb,-1,OP_ID,1,'real(8)',OP_RW),  &
    ...
    !# Missing code here that can't be merged
    ! Update position
    call getacc_updpos_host(&
                     & "getacc_updpos",s_nodes,  &
