...
__constant__ float gm1i;
__constant__ float m2;
__constant__ float wtg1[2];
__constant__ float xi1[2];
__constant__ float Ng1[4];
__constant__ float Ng1_xi[4];
__constant__ float wtg2[4];
__constant__ float Ng2[16];
__constant__ float Ng2_xi[32];
__constant__ float minf;
__constant__ float freq;
__constant__ float kappa;
__constant__ float nmode;
__constant__ float mfan;
