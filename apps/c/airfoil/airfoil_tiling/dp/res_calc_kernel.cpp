...
*/
  ...
  for (int n=0; n<nelem; n++) {
    ...
    res_calc(  ind_arg0 + glb_pedge_map[2*(n+offset_b) + 0]*2,
               ind_arg0 + glb_pedge_map[2*(n+offset_b) + 1]*2,
               ind_arg1 + glb_pecell_map[2*(n+offset_b) + 0]*4,
               ind_arg1 + glb_pecell_map[2*(n+offset_b) + 1]*4,
               ind_arg2 + glb_pecell_map[2*(n+offset_b) + 0]*1,
               ind_arg2 + glb_pecell_map[2*(n+offset_b) + 1]*1,
               arg6_l,
               arg7_l );
