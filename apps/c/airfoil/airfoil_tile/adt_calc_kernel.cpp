...
void op_par_loop_adt_calc(op_kernel_descriptor *desc) {
  ...
  for (int col = 0; col < desc->subset->ncolors; col++) {
    ...
    for (int n=desc->subset->color_offsets[2*col]; n<desc->subset->color_offsets[2*col+1]; n++) {
      ...
      adt_calc( (double *)p_a[0],  (double *)p_a[1],  (double *)p_a[2],  (double *)p_a[3],
...
void op_par_loop_adt_calc_enqueue(char const *name, op_set set,
                                              op_arg arg0,
                                              op_arg arg1,
                                              op_arg arg2,
                                              op_arg arg3,
  ...
  kern.args[4] = arg4;
  kern.args[5] = arg5;
  kern.function = op_par_loop_adt_calc;
