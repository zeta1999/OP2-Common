    ...
    for ( int col=0; col<Plan->ncolors; col++ ){
      ...
      for ( int blockIdx=0; blockIdx<nblocks; blockIdx++ ){
        ...
        for ( int n=presweep/VECSIZEH; n<(offset_b+nelem)/VECSIZEH; n++ ){
          ...
          intv_half map3idx(&arg2.map_data_d[VECSIZEH*n + set_size * 1]);
          ...
          res_calc_vec(
            ...
            arg7_p);
          mapidx = 4*map2idx;
          store_scatter_add(arg6_p[0], (double*)arg6.data+0, mapidx);
          store_scatter_add(arg6_p[1], (double*)arg6.data+1, mapidx);
          store_scatter_add(arg6_p[2], (double*)arg6.data+2, mapidx);
          store_scatter_add(arg6_p[3], (double*)arg6.data+3, mapidx);
          mapidx = 4*map3idx;
          store_scatter_add(arg7_p[0], (double*)arg7.data+0, mapidx);
          store_scatter_add(arg7_p[1], (double*)arg7.data+1, mapidx);
          store_scatter_add(arg7_p[2], (double*)arg7.data+2, mapidx);
          store_scatter_add(arg7_p[3], (double*)arg7.data+3, mapidx);
        }
