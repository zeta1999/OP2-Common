...
//user function
#include "res_calc.h"
inline void res_calc_vec(floatv_half *x1,  floatv_half *x2,  floatv_half *q1,  floatv_half *q2,
                     floatv_half *adt1,floatv_half *adt2,floatv_half *res1,floatv_half *res2) {
  floatv_half dx,dy,mu, ri, p1,vol1, p2,vol2, f;
...
void op_par_loop_res_calc(char const *name, op_set set,
  ...
  if (exec_size >0) {
    ...
    for ( int n=0; n<exec_size/8; n++ ){
      ...
      intv map2idx(&arg2.map_data_d[8*n + set_size * 0]);
      intv map3idx(&arg2.map_data_d[8*n + set_size * 1]);
      ...
      floatv arg2_p[4] = {
        ...
        floatv((float*)arg2.data, mapidx, 2),
        floatv((float*)arg2.data, mapidx, 3)};
      mapidx = 4*map3idx;
      floatv arg3_p[4] = {
        floatv((float*)arg3.data, mapidx, 0),
        floatv((float*)arg3.data, mapidx, 1),
        floatv((float*)arg3.data, mapidx, 2),
        floatv((float*)arg3.data, mapidx, 3)};
      floatv arg4_p[1] = {
        floatv((float*)arg4.data, map2idx, 0)};
      floatv arg5_p[1] = {
        floatv((float*)arg5.data, map3idx, 0)};
      floatv arg6_p[4] = {
        floatv(0.0f),
        floatv(0.0f),
        floatv(0.0f),
      ...
      res_calc_vec(
        ...
        arg7_p);
      mapidx = 4*map2idx;
      store_scatter_add(arg6_p[0], (float*)arg6.data, mapidx,0);
      store_scatter_add(arg6_p[1], (float*)arg6.data, mapidx,1);
      store_scatter_add(arg6_p[2], (float*)arg6.data, mapidx,2);
      store_scatter_add(arg6_p[3], (float*)arg6.data, mapidx,3);
      mapidx = 4*map3idx;
      store_scatter_add(arg7_p[0], (float*)arg7.data, mapidx,0);
      store_scatter_add(arg7_p[1], (float*)arg7.data, mapidx,1);
      store_scatter_add(arg7_p[2], (float*)arg7.data, mapidx,2);
      store_scatter_add(arg7_p[3], (float*)arg7.data, mapidx,3);
    }
