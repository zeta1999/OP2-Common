...
//user function
#include "update.h"
inline void update_vec(floatv_half *qold, floatv_half *q, floatv_half *res, floatv_half *adt, floatv_half *rms){
  floatv_half del, adti;
...
void op_par_loop_update(char const *name, op_set set,
  ...
  if (exec_size >0) {
    ...
    for ( int n=0; n<exec_size/8; n++ ){
      ...
      floatv arg1_p[4];
      floatv arg2_p[4] = {
        floatv(&((float*)arg2.data)[8*4 * n +0], 4),
        floatv(&((float*)arg2.data)[8*4 * n +1], 4),
        floatv(&((float*)arg2.data)[8*4 * n +2], 4),
        floatv(&((float*)arg2.data)[8*4 * n +3], 4)};
      floatv arg3_p[1] = {floatv(&((float*)arg3.data)[8 * n])};
      floatv arg4_l(0.0f);
      update_vec(
        arg0_p,
        arg1_p,
      ...
      store_stride(arg2_p[0],&((float*)arg2.data)[8*4 * n +0], 4);
      store_stride(arg2_p[1],&((float*)arg2.data)[8*4 * n +1], 4);
      store_stride(arg2_p[2],&((float*)arg2.data)[8*4 * n +2], 4);
      store_stride(arg2_p[3],&((float*)arg2.data)[8*4 * n +3], 4);
