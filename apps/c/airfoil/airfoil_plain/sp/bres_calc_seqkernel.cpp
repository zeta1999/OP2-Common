...
//user function
#include "bres_calc.h"
inline void bres_calc_vec(floatv_half *x1,  floatv_half *x2,  floatv_half *q1,
                      floatv_half *adt1,floatv_half *res1,intv_half *bound) {
...
void op_par_loop_bres_calc(char const *name, op_set set,
  ...
  if (exec_size >0) {
    ...
    for ( int n=0; n<exec_size/8; n++ ){
      ...
      floatv arg3_p[1] = {
        floatv((float*)arg3.data, map2idx, 0)};
      floatv arg4_p[4] = {
        floatv(0.0f),
        floatv(0.0f),
        floatv(0.0f),
        floatv(0.0f)};
      intv arg5_p[1] = {intv(&((int*)arg5.data)[8 * n])};
      bres_calc_vec(
        arg0_p,
        arg1_p,
        arg2_p,
        ...
        arg5_p);
      mapidx = 4*map2idx;
      store_scatter_add(arg4_p[0], (float*)arg4.data, mapidx,0);
      store_scatter_add(arg4_p[1], (float*)arg4.data, mapidx,1);
      store_scatter_add(arg4_p[2], (float*)arg4.data, mapidx,2);
      store_scatter_add(arg4_p[3], (float*)arg4.data, mapidx,3);
    }
