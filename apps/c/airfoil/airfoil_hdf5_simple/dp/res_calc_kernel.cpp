...
#pragma omp parallel for
      for (int blockIdx=0; blockIdx<nblocks; blockIdx++) {
        ...
        for (int n=0; n<nelem; n++) {
          res_calc(  &((double *)arg0.data)[2*arg0.map_data[2*(n+offset_b)+0]],
                     &((double *)arg0.data)[2*arg0.map_data[2*(n+offset_b)+1]],
                     &((double *)arg2.data)[4*arg2.map_data[2*(n+offset_b)+0]],
                     &((double *)arg2.data)[4*arg2.map_data[2*(n+offset_b)+1]],
                     &((double *)arg4.data)[1*arg4.map_data[2*(n+offset_b)+0]],
                     &((double *)arg4.data)[1*arg4.map_data[2*(n+offset_b)+1]],
                     &((double *)arg6.data)[4*arg6.map_data[2*(n+offset_b)+0]],
                     &((double *)arg6.data)[4*arg6.map_data[2*(n+offset_b)+1]]);                     
        }
      }
