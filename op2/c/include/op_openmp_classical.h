...
//
template <class T0>
void op_par_loop_omp(void (*kernel)(T0*),
...
void op_par_loop_omp(void (*kernel)(T0*, T1*),
    char const * name, op_set set,
...
void op_par_loop_omp(void (*kernel)(T0*, T1*, T2*),
    char const * name, op_set set,
...
void op_par_loop_omp(void (*kernel)(T0*, T1*, T2*, T3*),
    char const * name, op_set set,
